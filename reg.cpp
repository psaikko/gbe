...
ostream &operator<<(ostream &out, const Registers &reg) {
    cout << "Write " << reg.AF << " " << reg.BC << " " << reg.DE << " " << reg.HL << " " << reg.SP << " " << reg.PC
         << " " << reg.TCLK << " " << reg.IME << " " << reg.HALT << endl;
